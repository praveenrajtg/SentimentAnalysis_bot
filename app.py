...
with st.sidebar:
    ...
    if st.session_state.chat_history:
        ...
        with col2:
            st.metric("Positive %", f"{(sentiments.count('positive')/len(sentiments)*100):.1f}%")
            st.metric("Negative %", f"{(sentiments.count('negative')/len(sentiments)*100):.1f}%")
...
with col2:
    ...
    **Bot Responses:**
    - Adapts tone based on your emotion
    - Provides empathetic responses
    - Aims to improve satisfaction
    """)
